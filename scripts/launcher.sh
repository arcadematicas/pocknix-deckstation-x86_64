...
DECKSTATION_ROOT="$(cd "$SCRIPT_DIR/../.." && pwd)"

# Exportamos DECKSTATION_ROOT para que Update_DeckStation.sh lo use directamente
export DECKSTATION_ROOT

# La carpeta centralizada para todos los archivos del actualizador
UPDATER_DIR="$DECKSTATION_ROOT/Apps/Updater"

echo "================================================="
echo "   🚀 INICIANDO ENTORNO PORTABLE DECKSTATION"
echo "================================================="
echo "   Raíz DeckStation: $DECKSTATION_ROOT"
echo "================================================="
