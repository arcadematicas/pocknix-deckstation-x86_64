...
DECKSTATION_ROOT="$(cd "$(dirname "$(readlink -f "${BASH_SOURCE[0]}")")" && pwd)"
cd "$DECKSTATION_ROOT"
...
RA_HOME="$DECKSTATION_ROOT/Apps/retroarch/RetroArch-Linux-x86_64.AppImage.home"
